...
@section('contentUtama')
    <div class='d-flex justify-content-center align-items-center flex-column h-100'>
        <div class='d-flex justify-content-between w-100'>
            <div>
                ...
                <div class='menuTitle'>Check-Out</div>
            </div>
        </div>
        <div class='d-flex justify-content-between w-100 flex-wrap my-4'>
            <div class='tableContainerCustom w-100 px-3 py-3' style='overflow-y: scroll;'>
                <table class='tableCustom'>
                    <thead>
                        <tr>
                            <th scope="col" class='col-6'>Nama Tamu</th>
                            <th scope="col" class='col-4'>No Kamar</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $data_b)
                            <tr class='trCustom' style='cursor: default'>
                                <td>
                                    <div class='tableCustomContent'  style='width: 97%'>{{ $data_b->NAMA_TAMU }}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    onclick="window.location = 'konfirmasiCheckOut/{{ $data_b->ID_TAMU }}'">Konfirmasi</div>
                                </td>
                            </tr>
                            @php
                                $count++;
    ...
    @section('buttons')
        ...
        <div class='sidebarButtons'>
            ...
            <div class='buttonSidebarSmall buttonSelected d-flex align-items-center' onclick="window.location = 'mainCheckOut'">
                <img src='{{ asset('Assets/img/icon_white_kurang.svg') }}' style='margin: 0 0.25em 0 0'>Check-Out
            </div>
